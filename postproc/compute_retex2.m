function [strat_1, strat_2]=compute_retex(~)
...
for ii=1:length(scen)
    ...
    [strat_1(:,:,:,ii), strat_2(:,:,:,ii), VV2_1, VV2_2] = optimize_nolimit(50, 50, C, D_C_min, D_C_max, D, P_f_min, P_f_max, F, ...
                                                  ...
                                                  voteModel, vmArgs, estrat, prefstrats_eideal, sigma, 2);
end
strat_1_retro_as2 = strat_1;
strat_2_retro_as2 = strat_2;
savefile = 'retro_as2_bhigher.mat'
save(savefile,'strat_1_retro_as2','strat_2_retro_as2')