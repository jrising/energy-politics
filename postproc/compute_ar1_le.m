function [strat_1, strat_2]=compute_ar1_le(b)
    ...
    scen = cartprod(lambda_p, lambda_p);
...
for ii=1:length(scen)
    ...
    [strat_1(:,:,:,:,ii), strat_2(:,:,:,:,ii), VV2_1, VV2_2] = optimize_nolimit_ar1op(50, 50, C, D_C_min, D_C_max, D, P_f_min, P_f_max, F, ...
                                                  ...
                                                  4, voteModel, [vmArgs .5], estrat, prefstrats, sigma, 2);                                         
end

%strat_1_ar1_as1 = strat_1;
%strat_2_ar1_as1 = strat_2;
%bname = num2str(round(b*10));
%savefile = strcat(bname,'ar1_as1_newbatch.mat');
%save(savefile,'strat_1_ar1_as1','strat_2_ar1_as1');